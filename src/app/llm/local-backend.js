...
function getModelContextLength() {
  ...
  if (!model) return (typeof C === 'function' ? C() : window.CONSTANTS)?.DEFAULT_CTX_LIMIT_TOKENS || 32000;
  if (typeof ollamaBackend !== 'undefined' && !ollamaBackend.enabled) {
    return (typeof C === 'function' ? C() : window.CONSTANTS)?.DEFAULT_CTX_LIMIT_TOKENS || 32000;
  }
