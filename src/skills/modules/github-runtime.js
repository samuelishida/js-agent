// src/skills/modules/github-runtime.js
// GitHub REST API skill: search code, PRs, issues, file contents.
// Requires a GitHub token stored in window.githubToken or localStorage('github_token').
// Publishes: window.AgentSkillModules.createGithubRuntime
...
(() => {
  ...
  window.AgentSkillModules.createGithubRuntime = function createGithubRuntime({ formatToolResult }) {
