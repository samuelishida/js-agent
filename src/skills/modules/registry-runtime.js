(() => {
  ...
  window.AgentSkillModules.createRegistryRuntime = function createRegistryRuntime(handlers = {}) {
    ...
    function buildSkillGroupsForUi(groups) {
      ...
      filesystem: {
        ...
        tools: [
          ...
          defineTool({
            ...
            signature: 'fs_download_file(...) // browser download fallback/export',
          ...
          defineTool({
            name: 'fs_write_file',
            signature: 'fs_write_file(...) // writes file or falls back to download',
    ...
    return {
      ...
      skillGroups: buildSkillGroupsForUi(groupedTools)
    };
  };
})();
